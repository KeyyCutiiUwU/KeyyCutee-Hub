...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://16641137818"
...
ImageButton1.Image = "http://www.roblox.com/asset/?id=16641137818"
...
function Update:Window(text,logo,keybind)
    ...
    Ping.Text = "Keyy Hub | https://discord.com/invite/rGWjPJE7"
	...
	Logo.Image = "rbxassetid://16680930159"
...
Page.Image = "http://www.roblox.com/asset/?id=" .. tostring(16502756484)
    ...
    function main:AddButton(text, callback)
        ...
        ImageButton.Image = "rbxassetid://16641137818"
        ...
        Space.TextColor3 = Color3.fromRGB(0, 255, 0)
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://16641137818"
    ...
    function main:AddDropdown(text,option,callback)
        ...
        DropImage.Image = "rbxassetid://16641137818"
    ...
    function main:Dis(text,display)
        ...
        Labeld.TextColor3 = Color3.fromRGB(0, 255, 0)
...
local Library = Update:Window("KEYYCUTI HUB","",Enum.KeyCode.RightControl);

--local KhangRoblox = Library:AddTab("Information","4483345998")
local Main = Library:AddTab("Chủ Yếu","6026568198")
local M = Library:AddTab("Vật Phẩm","7485051715")
local Ss = Library:AddTab("Thống Kê","7040410130")
local RaceV4 = Library:AddTab("Race V4","11162889532")
local P = Library:AddTab("Chiến Đấu","7251993295")
local R = Library:AddTab("Đột Kích","11155986081")
local T = Library:AddTab("Di Chuyển","11155851001")
local S = Library:AddTab("Cửa Hàng","6031265976")
local D = Library:AddTab("Trái Ác Quỷ","130882646")
local Misc = Library:AddTab("Linh Tinh","11156061121")

Main:AddSeperator("Cày Đặt Farm")
...
Main:AddDropdown("Chọn Tấn Công Nhanh", AttackList,function(MakoGay)
...
while wait(.1) do
    if _G.FastAttack then
       ...
       Main:AddToggle("Auto Bật V4",false,function(value)
       ...
       Main:AddToggle("Auto Lưu Điểm Hồi Sinh",true,function(value)
    _G.Set = value
end)
...
Main:AddToggle("Đánh Nhanh",true,function(value)
   ...
   Main:AddSeperator("Mục Farm Level")
   ...
   Main:AddToggle("Farm Gần Nhất",_G.AutoFarmNearest,function(value)
...
spawn(function()
    ...
    Main:AddLabel("Mục Farm Rương")
    
Main:AddToggle("Bay Đến Rương [ No Kick ]",false,function(value)
 AutoFarmChest = value
...
Main:AddToggle("Dịch Chuyển Farm Rương [ Dễ Kick ]",false,function(vu)
	_G.ChestBypass = vu
end)
...
if _G.ChestBypass then
    ...
    Main:AddSeperator("Mục Farm Katakuri")
        ...
        while wait() do
            pcall(function()
                if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88 then
                    MobKilled:Set("Còn Lại Quái : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,41))
                elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87 then
                    MobKilled:Set("Còn Lại Quái : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,40))
                elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
                    MobKilled:Set("Còn Lại Quái : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,39))
                else
                    MobKilled:Set("Bot Đang Được Triệu Hồi")
                end
            end)
        end
    end)
    
    Main:AddToggle("Farm Katakuri V1",_G.AutoDoughtBoss,function(value)
    ...
    Main:AddToggle("Auto Triệu Hồi Katakuri",true,function(value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner",value)
    end)
    
    Main:AddToggle("Farm Katakuri V2", _G.Autodoughking,function(value)
...
local BossName = Main:AddDropdown("Lựa Chọn Boss", bossCheck, function(value)
    _G.SelectBoss = value
end)

Main:AddButton("Hủy Chọn Boss", function()
BossName:Clear()
wait(0.1)
for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
    ...
    Main:AddToggle("Farm Tất Cả Boss",_G.AutoAllBoss,function(value)
        _G.AutoAllBoss = value
        StopTween(_G.AutoAllBoss)
    end)
    
    Main:AddToggle("Nhận Nhiệm Vụ Boss",false,function(value)
    _G.Auto_Quest_Boss = value
    end)
    
    Main:AddToggle("Farm Tất Cả Boss Đổi Sv",_G.AutoAllBossHop,function(value)
...
spawn(function()
    ...
    Main:AddSeperator("Cày Đặt Farm 2")
    
Main:AddToggle("Dồn Quái 1 Chỗ",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
local Bring = {"Thấp", "Bình Thường", "Siêu Cấp"}
_G.BringMode = "Normal"
Main:AddDropdown("Chọn Chế Độ Dồn Quái", Bring,function(value)
    _G.BringMode = value
end)
spawn(function()
    while wait(.1) do
...
Main:AddToggle("Auto Bật Haki",true,function(value)
_G.AUTOHAKI = value
end)
spawn(function()
    while wait(.1) do
...
Main:AddToggle("Auto Đánh",false,function(value)
_G.AutoClick = value
end)

Main:AddToggle("Xóa Văn Bản Thông Báo",false,function(NamfonGay)
...
Main:AddToggle("Loại bỏ âm thanh và tăng cấp",false,function(Remo)
_G.RemoveHit = Remo
end)
...
spawn(function()
    ...
    Main:AddToggle("Loại Bỏ Vũ Khí",false,function(value)
    getgenv().A = require(game:GetService("ReplicatedStorage").CombatFramework.RigLib).wrapAttackAnimationAsync 
getgenv().B = require(game.Players.LocalPlayer.PlayerScripts.CombatFramework.Particle).play
spawn(function()
    ...
    spawn(function()
      ...
      if _G.WhiteScreen then
        ...
        Main:AddToggle("Màn Hình Trắng (Mượt)",_G.WhiteScreen,function(value)
...
elseif _G.WhiteScreen == false then
    ...
    Main:AddSeperator("Cày Đặt Farm Mode")
    ...
    Main:AddSeperator("Cày Đặt Farm Thông Thạo Trái")
    ...
    Mirragecheck:Set(' Đảo Kì Bí Đã Có 🏝️✅')
    else
      Mirragecheck:Set(' Chưa Xuất Hiện Đảo 🏝️❌' )end
            end
        end)
end)

Mirragecheck = M:AddLabel("")
M:AddToggle("Bay Đến Đảo Kì Bí",_G.AutoMysticIsland,function(value)
        ...
        spawn(function()
            ...
            M:AddButton("Bay Lại NPC Fruit Đảo Kì Bí", function()
                TweenNpc()
                end)
    ...
    M:AddToggle("Tự Động Đảo Kì Bí",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
M:AddToggle("Lụm Bánh Răng",_G.TweenMGear,function(value)
_G.TweenMGear = value
...
M:AddSeperator(" Mục Farm Vật Liệu ")
...
M:AddToggle("Farm Răng Nanh",false,function(value)
BjirVampire = value
...
spawn(function()
    ...
    M:AddToggle("Farm Nước Mắt Thần Bí",false,function(value)
_G.Makori_gay = value
...
spawn(function()
    ...
    M:AddToggle("Farm Quặng Dung Nham",_G.Makori_gay,function(value)
_G.Umm = value
StopTween(_G.Umm)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm Sắt Vụn",false,function(value)
Scrap = value
StopTween(Scrap)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm Bột Cocoa Kì Diệu",false,function(value)
Cocoafarm = value
StopTween(Cocoafarm)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm Đuôi Cá",false,function(value)
Fish = value
StopTween(Fish)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm Ngà Nhỏ",false,function(value)
MiniHee = value
StopTween(MiniHee)
end)
...
spawn(function()
    ...
    M:AddToggle("Đổi Server Farm",_G.Makori_gay,function(value)
    _G.StardHop = value
    end)
    
    M:AddSeperator(" Quái Vật Biển")
    ...
    spawn(function()
        ...
        M:AddToggle('Kill Tàu Cướp Biển', _G.KillGhostShip, function(value)
...
M:AddToggle('Kill Sea Beast Đổi Server', false, function(value)
    _G.AutoSeaBestHop = value
    end)
    
M:AddSeperator(" Sự Kiện Biển ")

M:AddToggle(' Dịch Chuyển Đến Đảo Leviathan', false, function(value)
...
M:AddToggle("Auto Kill Cá Mập",_G.Makori_gay,function(value)
_G.bjirShark = value
...
spawn(function()
    ...
    M:AddToggle("Auto Kill Cá Điện ",_G.Makori_gay,function(value)
...
spawn(function()
        ...
        M:AddToggle('Auto Kill Tàu Ma', _G.bjirFishBoat, function(value)
...
M:AddToggle('Tự Động Lấy Item Mỏ Neo [ Cần vật liệu ]', _G.BjirAnchorCuy, function(state)
...
elseif state and (not findItem("Monster Magnet", 1) or not findItem("Terror Eyes", 2) and not findItem("Electric Wing", 8) and not findItem("Fool's Gold", 20) and not findItem("Shark Tooth", 10)) then
    ...
    game.StarterGui:SetCore("SendNotification", {
        Icon = "rbxassetid://16641137818",
        Title = "❌ Cảnh Báo ❌", 
        Text = "Bạn Phải Cần Thêm \nto Nguyên Liệu Mua Monster Magnet."
    })
else
    _G.BjirAnchorCuy = false
end
...
spawn(function()
    ...
    M:AddToggle("Tự Lái Thuyền Ra Vùng Biển",_G.BiirTrax,function(state)
    if state then
        _G.BiirTrax = true
    else
        _G.BiirTrax = false
...
spawn(function()
   ...
   M:AddSeperator("Cày Thông Thạo")
    
    M:AddToggle("Farm Trái Mastery",_G.AutoFarmFruitMastery,function(value)
    ...
    M:AddToggle("Farm Súng Mastery",_G.AutoFarmGunMastery,function(value)
    ...
    M:AddSeperator(" Kiếm Buddy ")
    
    M:AddToggle("Tự Động Kiếm Buddy",_G.AutoBudySword,function(value)
        _G.AutoBudySword = value
        StopTween(_G.AutoBudySword)
    end)
    
    M:AddToggle("Tự Động Kiếm Buddy + Đổi Sv",_G.AutoBudySwordHop,function(value)
    ...
    spawn(function()
        while wait() do
            ...
            M:AddSeperator(" Kiếm Koko ")
    
    M:AddToggle("Tự Động Kiếm Koko", _G.AutoOderSword,function(value)
         _G.AutoOderSword = value
        StopTween( _G.AutoOderSword)
    end)
    
    M:AddToggle("Tự Động Kiếm Koko + Đổi Sv", _G.AutoOderSwordHop,function(value)
    ...
    M:AddButton("Bắt Đầu Vào Raid Boss Law",function()
        if World2 then
    ...
    local FM = M:AddLabel('Vui Lòng Qua Sea 3')
...
M:AddToggle("Tự Động Song Kiếm Oden",_G.AutoCdk,function(value)
...
M:AddToggle("Tự Động Kiếm Tushita", _G.Autotushita,function(value)
         _G.Autotushita = value
        StopTween( _G.Autotushita)
    end)
    
    M:AddToggle("Tự Động Kiếm Tushita + Đổi Sv", _G.Autotushitahop,function(value)
    ...
    M:AddToggle("Tự Động Kiếm Cavander", _G.AutoCarvender,function(value)
         _G.AutoCarvender = value
        StopTween( _G.AutoCarvender)
    end)
    
    M:AddToggle("Tự Động Kiếm Carvander", _G.AutoCarvenderhop,function(value)
    ...
    M:AddSeperator("Hải Tặc Pháo Đài")
    
    M:AddToggle("Farm Hải Tặc", _G.AutoRaidPirate,function(value)
...
spawn(function()
    ...
    M:AddSeperator(" Song Móc ")
    
    M:AddToggle("Tự Động Song Móc", _G.AutoTwinHook,function(value)
         _G.AutoTwinHook = value
        StopTween( _G.AutoTwinHook)
    end)
    
    M:AddToggle("Tự Động Song Móc + Đổi Sv", _G.AutoTwinHook_Hop,function(value)
    ...
    spawn(function()
        pcall(function()
            while wait() do
                EliteProgress:Set("Đã Đánh Được : "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
            end
        end)
    end)
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
					Elite_Hunter_Status:Set("Elite Đã Có ✅")	
				else
					Elite_Hunter_Status:Set("Elite Chưa Có ❌")	
				end
			end)
		end
	end)
    ...
    M:AddToggle("Kill Elite + Đổi Server",_G.AutoEliteHunterHop,function(value)
        _G.AutoEliteHunterHop = value
    end)
    
    M:AddSeperator("Lưỡi Hái Bóng Tối")
    
    M:AddToggle("Tự Động Lưỡi Hái Bóng Tối",_G.AutoFarmBossHallow,function(value)
        _G.AutoFarmBossHallow = value
        StopTween(_G.AutoFarmBossHallow)
    end)
    
    M:AddToggle("Tự Động Lưỡi Hái + Đổi Sv",_G.AutoFarmBossHallowHop,function(value)
    ...
    M:AddSeperator("Yuru Mini")
    
    M:AddToggle("Kill Rip_Indra",_G.AutoDarkDagger,function(value)
    ...
    M:AddToggle("Kill Rip_Indra + Đổi Sv",_G.AutoDarkDagger_Hop,function(value)
...
M:AddToggle("Triệu Hồi Rip_indra [ Cần 3 Haki Legen ]",false,function()
AutoHaki()
wait(0.5) 
local args = {
[1] = "activateColor",
...
HyperCahaya(CFrame.new(-5419.98095703125, 1093.3375244140625, -2666.730712890625))
    ...
    M:AddSeperator("Đinh Ba Gai")
	
	M:AddToggle("Tự Động Đinh Ba Gai", _G.Auto_Dragon_Trident,function(value)
         _G.Auto_Dragon_Trident = value
        StopTween(_G.Auto_Dragon_Trident)
    end)
    
    M:AddToggle("Tự Động Đinh Ba Gai + Đổi Sv", _G.Auto_Dragon_Trident_Hop,function(value)
	...
	M:AddSeperator(" Kiếm Quản Ngục ")
	
	M:AddToggle("Tự Động Kiếm Quản Ngục", _G.Autowaden,function(value)
         _G.Autowaden = value
        StopTween( _G.Autowaden)
    end)
    
    M:AddToggle("Tự Động Kiếm Quản Ngục + Đổi Sv", _G.Autowadenhop,function(value)
    ...
    M:AddSeperator(" Boss Râu Trắng ")
    
    M:AddToggle("Kill Râu Trắng", _G.Autodoughking,function(value)
         _G.Autogay = value
        StopTween( _G.Autogay)
    end)
    
    M:AddToggle("Kill Râu Trắng + Đổi Sv", _G.AutodoughkingHop,function(value)
         _G.Autogayhop = value
    end)
    ...
    M:AddSeperator(" Lôi Gậy V1 ")
    
    M:AddToggle("Tự Động Lôi Gậy V1", _G.Autodoughking,function(value)
         _G.Autopole = value
        StopTween( _G.Autopole)
    end)
    
    M:AddToggle("Tự Động Lôi Gậy + Đổi Sv", _G.AutodoughkingHop,function(value)
    ...
    M:AddSeperator(" Kính Thiên Nga ")
    
    M:AddToggle("Tự Động Kính Swan",_G.AutoFarmSwanGlasses,function(value)
    ...
    M:AddToggle("Tự Động Kính Swan + Đổi Sv",_G.AutoFarmSwanGlasses_Hop,function(value)
        _G.AutoFarmSwanGlasses_Hop = value
    end)
    
    M:AddSeperator(" Cưa Cá Mập ")
    
    M:AddToggle("Tự Động Cưa Cá Mập", _G.Autodoughking,function(value)
         _G.Autosaw = value
        StopTween( _G.Autopole)
    end)
    
    M:AddToggle("Tự Động Cưa Cá Mập + Đổi Sv", _G.AutodoughkingHop,function(value)
         _G.Autosawhop = value
    end)
    ...
    M:AddSeperator("Mục Farm Rương")
    
    BoneCheck = M:AddLabel("Xương Của Bạn Có : Qua Sea 3")
    
    spawn(function()
        while wait() do
            pcall(function()
                BoneCheck:Set("Xương Của Bạn Có : "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check")))
            end)
        end
    end)
    ...
    M:AddToggle("Quay Xương",_G.Auto_Random_Bone,function(value)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                ObservationRange:Set("Cấp Haki Quan Sát : "..math.floor(game:GetService("Players").LocalPlayer.VisionRadius.Value))
            end)
        end
    end)
    
    M:AddToggle("Farm Haki Quan Sát",_G.AutoObservation,function(value)
    ...
    M:AddToggle("Farm Haki Quan Sát + Đổi Sv",_G.AutoObservation_Hop,function(value)
                ...
                if _G.AutoObservation then
                    if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
                        game:GetService("StarterGui"):SetCore("SendNotification", {
                            Icon = "rbxassetid://0";
                            Title = "Trạng Thái Haki Qs ✅", 
                            Text = "Bạn Đã Max Haki Qs"
                        })
                        wait(2)
                    else
                        if World2 then
    ...
    M:AddToggle("Tự Động Saber",_G.AutoSaber,function(value)
			...
			M:AddToggle("Tự Động Saber + Đổi Sv",_G.AutoSaberHop,function(value)
 ...
 spawn(function()
    ...
    M:AddSeperator(" Kiếm Legendary ")
    
    M:AddToggle("Mua Kiếm Legendary",_G.AutoBuyLegendarySword,function(value)
    ...
    M:AddToggle("Mua Kiếm Legendary + Đổi Sv",_G.AutoBuyLegendarySword_Hop,function(value)
        _G.AutoBuyLegendarySword_Hop = value
    end)
    
    M:AddSeperator(" Haki Sắc Màu ")
    
    M:AddToggle("Mua Haki Sắc Màu",_G.AutoBuyEnchancementColour,function(value)
        _G.AutoBuyEnchancementColour = value
    end)
    
    M:AddToggle("Mua Haki Sắc Màu + Đổi Sv",_G.AutoBuyEnchancementColour_Hop,function(value)
    ...
    M:AddSeperator(" Mục khác ")
    
    M:AddToggle("Buy Mũ Lính Ngự Lâm",_G.AutoMusketeerHat,function(value)
    ...
    M:AddToggle("Tự Động Lấy Haki 7 Màu",_G.Auto_Rainbow_Haki,function(value)
    ...
    M:AddToggle("Làm Nhiệm Vụ Haki V2",_G.AutoObservationHakiV2,function(x)
    ...
    M:AddToggle("Làm Nhiệm Vụ Nâng Tộc V2",_G.Auto_EvoRace,function(value)
    ...
    M:AddToggle("Nhiệm Vụ Bartilo",_G.AutoBartilo,function(value)
    ...
    M:AddToggle("Tự Động Đốt Đuốc",_G.AutoHolyTorch,function(value)
...
spawn(function()
	while wait() do
		...
		local count = 0
		for i,v in pairs(game.workspace:GetChildren()) do
			if string.find(v.Name,"Rương") and v:IsA("Part") then
				count10 = count10 + 1
			end
		end
		for i,v in pairs(game.Workspace:GetChildren()) do
...
Chest = Ss:AddLabel("Rương Server 🎁")

Fruit = Ss:AddLabel("Trái Server 🍎")

  local Pointstat = Ss:AddLabel("Điểm Reset Chỉ Số 📑")
...
local Melee = Ss:AddLabel("Chỉ Số Võ 🦸🏻: ")
local Defense = Ss:AddLabel("Chỉ Số Phòng Thủ 🛡️: ")
local Sword = Ss:AddLabel("Chỉ Số Kiếm 🗡️: ")
local Gun = Ss:AddLabel("Chỉ Số Súng 🔫 : ")
local Fruit = Ss:AddLabel("Chỉ Số Trái 🍎 : ")
...
RaceV4:AddLabel("Vui Lòng Qua Sea 3 =))))")
end

if World3 then
    RaceV4:AddSeperator(" Tộc V4 ")
    
RaceV4:AddButton("Bay Lên Đỉnh Cây Đại Thụ",function()
  HyperCahaya(CFrame.new(2947.556884765625, 2281.630615234375, -7213.54931640625))
    end)
    
    RaceV4:AddButton("Dịch Chuyển Đến Ngôi Đền",function()
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    end)
    
RaceV4:AddButton("Bay Đến Chỗ Gạt Cần",function()
  HyperCahaya(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
end)

RaceV4:AddButton("Bay Đến Chỗ Mua Gear [ Cần Ở Trong Đền ]",function()
...
SoundSFX.SoundId = "rbxassetid://16641137818"
SoundSFX:Play()
...
RaceV4:AddToggle("Kill Người Chơi Trong Trial ",false,function(value)
...
spawn(function()
  ...
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer('UpgradeRace','Buy')
        ...
        while wait() do
            pcall(function()
                for i,v in pairs(game:GetService("Players"):GetPlayers()) do
                    if i == 12 then
                        plyserv:Set("Players :".." "..i.." ".."/".." ".."12".." ".."(Full Người ✅)")
                    elseif i == 1 then
    ...
    P:AddToggle("Bay Đến Người Chơi",false,function(value)
    ...
    local TimeRaid = R:AddLabel("Chờ Đến Đảo 🏝️")
        ...
        pcall(function()
            while wait() do
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Timer.Visible == true then
                    ...
                    TimeRaid:Set("Chờ Đến Đảo Nhé 🏝️✅")
                end
            end
        end)
    end)
...
spawn(function()
    ...
    Island5:Set('Hiện Tại Đảo 5 🏝️✅')
      ...
      Island5:Set('Đảo 5 ❌' )end
        ...
        R:AddToggle("Auto Đảo Tiếp Theo",_G.Auto_Dungeon,function(value)
...
spawn(function()
    ...
    R:AddToggle("Auto Kill Quái",_G.concubu ,function(vu)
    _G.concubu  = vu
    end)
...
spawn(function()
    ...
    R:AddDropdown("Lựa Chọn Chip",Raidslist,function(value)
        _G.SelectChip = value
    end)
    ...
    R:AddToggle("Auto Mua Chip",_G.AutoBuyChip,function(value)
    ...
    R:AddToggle("Tự Động Vô Raid",_G.Auto_StartRaid,function(value)
    ...
    if World2 then
        R:AddButton("Dịch Chuyển Đến Chỗ Raid",function()
    ...
    if World2 then
        R:AddButton("Dịch Chuyển Đến Chỗ Thức Tỉnh",function()
    ...
    R:AddSeperator("Raid law")
    
 R:AddToggle("Auto Đánh Law", _G.AutoOderSword,function(value)
     _G.AutoOderSword = value
    StopTween( _G.AutoOderSword)
    end)
    
    R:AddToggle("Auto Đánh Law + Đổi Server", _G.AutoOderSwordHop,function(value)
         _G.AutoOderSwordHop = value
    end)
    ...
    R:AddButton("Mua Chip Raid Law",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    R:AddButton("Bắt Đầu Raid Law",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
        end
    end)
    ...
    T:AddButton("Dịch Chuyển Qua Sea 1",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    T:AddButton("Dịch Chuyển Qua Sea 2",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    T:AddButton("Dịch Chuyển Qua Sea 3",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
    T:AddButton("Dịch Chuyển Lại Seabeast",function()
        for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
            if v:FindFirstChild("HumanoidRootPart") then
    ...
    T:AddToggle("Bay Đến Đảo",false,function(value)
        ...
        if _G.TeleportIsland == true then
            repeat wait()
                ...
                elseif _G.SelectIsland == "Trung Tâm" then
                    HyperCahaya(CFrame.new(-690.33081054688, 15.09425163269, 1582.2380371094))
                elseif _G.SelectIsland == "Đảo Khỉ" then
                    HyperCahaya(CFrame.new(-1612.7957763672, 36.852081298828, 149.12843322754))
                elseif _G.SelectIsland == "Làng Hải Tặc" then
                ...
                elseif _G.SelectIsland == "Làng Băng Giá" then
                ...
                elseif _G.SelectIsland == "Làng Dung Nham" then
                    HyperCahaya(CFrame.new(-5247.7163085938, 12.883934020996, 8504.96875))
                elseif _G.SelectIsland == "Thành Phố Dưới Biển" then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
                elseif _G.SelectIsland == "Thành Phố Công Nghiệp" then
                ...
                elseif _G.SelectIsland == "Điểm Khởi Đầu" then
                    HyperCahaya(CFrame.new(-11.311455726624, 29.276733398438, 2771.5224609375))
                elseif _G.SelectIsland == "Đấu Trường Bóng Đêm" then
                ...
                elseif _G.SelectIsland == "Phòng Của Swan" then
                    HyperCahaya(CFrame.new(2284.4140625, 15.152037620544, 875.72534179688))
                elseif _G.SelectIsland == "Vườn Thực Vật" then
                ...
                elseif _G.SelectIsland == "Bay Lên Trời (Run)" then
                ...
                elseif _G.SelectIsland == "Bến Cảng" then
                ...
                elseif _G.SelectIsland == "Đảo Cocoa" then
                ...
                elseif _G.SelectIsland == "Đảo Mới (Tiki)" then
    ...
    T:AddToggle("Bay Đến NPC",_G.TeleportNPC,function(value)
    ...
    T:AddButton("Dịch Chuyển Chớp Mắt",function()
...
Misc:AddToggle("Graphic",false,function(v)
			if v then
				...
				c.Enabled = true
				c.Saturation = 0.2
				c.TintColor = Color3.fromRGB(0, 255, 0)
...
Misc:AddButton("Kaitun Cap", function(value)
		...
		for k,v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"..v,true) == 1 then 
				...
				huhu.Image = "rbxassetid://16641137818"
