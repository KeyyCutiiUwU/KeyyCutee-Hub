...
Closed.Image = "rbxassetid://16136469067"
    ...
    function library:AddWindow(text,keybind)
        ...
        function uitab:AddTab(text,image)
            ...
            function main:AddDropdown(text,table,callback)
                ...
                DropImage.Image = "rbxassetid://16136469067"
...
---------------------------------------------------------------------------Create Tab
local SOMEXHUB = library:AddWindow("KeyyCutii Hub",Enum.KeyCode.RightControl)
local Main = SOMEXHUB:AddTab("Chính","16136469067")
local Sea = SOMEXHUB:AddTab("Sự Kiện Biển","16136469067")
local M = SOMEXHUB:AddTab("Vật Phẩm","16136469067")
local Ss = SOMEXHUB:AddTab("Chỉ Số","16136469067")
local RaceV4 = SOMEXHUB:AddTab("Tộc V4","16136469067")
local P = SOMEXHUB:AddTab("Người chơi","16136469067")
local R = SOMEXHUB:AddTab("Tập Kích","16136469067")
local T = SOMEXHUB:AddTab("Di Chuyển","16136469067")
local S = SOMEXHUB:AddTab("Cửa Hàng","16136469067")
local D = SOMEXHUB:AddTab("Trái Ác Quỷ","16136469067")
local Misc = SOMEXHUB:AddTab("Khác","16136469067")
---------------------------------------------------------------------------
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function()
