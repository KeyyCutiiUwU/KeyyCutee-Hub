...
Closed.Image = "rbxassetid://16241461895 "
    ...
    function library:AddWindow(text,keybind)
        ...
        function uitab:AddTab(text,image)
            ...
            function main:AddDropdown(text,table,callback)
                ...
                DropImage.Image = "rbxassetid://16242758707 "
...
---------------------------------------------------------------------------Create Tab
local SOMEXHUB = library:AddWindow("KeyyCutii Hub | buy khang roblox",Enum.KeyCode.RightControl)
local Main = SOMEXHUB:AddTab("Mục Chính","16241461895 ")
local Sea = SOMEXHUB:AddTab("Mục Event Biển","16242758707 ")
local M = SOMEXHUB:AddTab("Mục Vật Phẩm","16241461895 ")
local Ss = SOMEXHUB:AddTab("Mục Chỉ Số","16242758707 ")
local RaceV4 = SOMEXHUB:AddTab("Mục V4","16241461895 ")
local P = SOMEXHUB:AddTab("Mục Người chơi","16242758707 ")
local R = SOMEXHUB:AddTab("Mục Đột Kích","16241461895 ")
local T = SOMEXHUB:AddTab("Mục Dịch Chuyển","16242758707 ")
local S = SOMEXHUB:AddTab("Mục Cửa Hàng","16241461895 ")
local D = SOMEXHUB:AddTab("Mục Trái","16242758707 ")
local Misc = SOMEXHUB:AddTab("Khác :))","16241461895 ")
---------------------------------------------------------------------------
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function()
...
Sea:AddToggle("Đánh Cá mập mẹ matday", _G.AutoTerrorshark,function(value)
    _G.AutoTerrorshark = value
   StopTween( _G.AutoTerrorshark)
end)

Sea:AddToggle("Đánh cá mập con",FarmTFully,function(value)
FarmShark = value
StopTween(FarmShark)
end)
...
Sea:AddToggle("Đánh cá điện",_G.farmpiranya,function(value)
...
spawn(function()
    pcall(function()
        while wait() do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
                FaiFaoKai:Set('🌝: Kitsune đã có')
            else
                FaiFaoKai:Set('🌚: Kitsune chưa có')
            end
        end
    end)
end)
    ...
    Sea:AddToggle("bay đến Kitsune",_G.AutoFKitsune,function(value)
...
Main:AddDropdown("Chọn quái để đánh",tableMon,function(vu)
    _G.SelectMob = vu
end)
    
    Main:AddToggle("Đánh quái đã chọn",_G.AutoFarmMob,function(value)
...
spawn(function()
    ...
    Main:AddToggle("Đổi server", _G.AutodoughkingHop,function(value)
...
local BoSs = Main:AddLabel("Tình Trạng: Chọn boss đi má=))")
...
elseif World3 then
	tableBoss = {"Stone","Island Empress","Kilo Admiral","Đội trưởng voi","Hải tặc hào hoa","rip_indra True Form","Longma bắc giang","Soul Reaper","Mẹ lớn bigmom"}
end
    ...
    Main:AddToggle("Đánh Hết Boss đổi server",_G.AutoAllBossHop,function(value)
...
Main:AddToggle("Màn Hình Đen (Bật lên cho mượt)",false,function(Umm)
...
spawn(function()
    ...
    Main:AddSeperator("Chọn chiêu farm DF")
    ...
    Mirragecheck:Set('🏝️: Đã có đảo kì bí')
    else
      Mirragecheck:Set('❌: Chưa có đảo kì bí' )end
            end
        end)
end)
...
M:AddToggle("Tự Động Farm Da",_G.Makori_gay,function(value)
_G.Leather = value
...
if World1 or world2 or World3 then    
M:AddToggle("Tự Động Farm sắt vụn metal",false,function(value)
Scrap = value
StopTween(Scrap)
end)
...
if World3 then  
M:AddToggle("Tự Động Farm Bột Cocoa",false,function(value)
Cocoafarm = value
StopTween(Cocoafarm)
end)
...
if World3 then  
M:AddToggle("Tự Động Farm Sừng Tê Giác",false,function(value)
MiniHee = value
StopTween(MiniHee)
end)
...
spawn(function()
    ...
    M:AddToggle("Đổi Server",_G.Makori_gay,function(value)
    _G.StardHop = value
    end)
...
M:AddToggle("Tự Động Soul Guitar + Đổi server",false,function(value)
...
M:AddToggle("Tự Động Tushita", _G.Autotushita,function(value)
    ...
    M:AddToggle("Tự Động Farm Cá Mập Mẹ Matday", _G.AutoTerrorshark,function(value)
         _G.AutoTerrorshark = value
        StopTween( _G.AutoTerrorshark)
    end)
    
    M:AddToggle("Tự Động Farm Cá Mập Con",FarmTFully,function(value)
    FarmShark = value
    StopTween(FarmShark)
    end)
    ...
    M:AddToggle("Tự Động Farm Cá Điện",_G.farmpiranya,function(value)
    _G.farmpiranya = value
    StopTween(_G.farmpiranya)
    end)
    
    M:AddToggle("Tự Động Đàn cá",_G.Fish_Crew_Member,function(value)
    _G.Fish_Crew_Member = value
    StopTween(_G.Fish_Crew_Member)
    end)
    
    M:AddToggle("Tự Động Cá Mập Mẹ Hop", _G.AutoTerrorsharkhop,function(value)
    ...
    spawn(function()
        pcall(function()
            while wait() do
                EliteProgress:Set("Đánh đc elite : "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
            end
        end)
    end)
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
					...
					Elite_Hunter_Status:Set("Status : Ko có elite>")	
				end
			end)
		end
	end)
...
function EquipAllWeapon()
    ...
    M:AddToggle('Bay Lại Quái Vật Biển)', false, function(value)
...
M:AddDropdown("Chọn Chế Độ Đi Bạn", ListB,function(value)
    BoneFMode = value
end)

    local BoneFarm = M:AddToggle("Tự Động Cày Xương",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
   ...
   local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
    ...
    M:AddToggle("Tự Động Quay Xương",_G.Auto_Random_Bone,function(value)
    ...
    M:AddToggle("Tự Động Cầu Nguyện",pry,function(value)
    _G.Pray = value
    end)
...
Fruit = Ss:AddLabel("Fruit")
  ...
  local Pointstat = Ss:AddLabel("Chỉ số điểm")
...
RaceV4:AddButton("Lên Đỉnh Cây",function()
...
RaceV4:AddButton("Gạt Cần",function()
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
  ...
  RaceV4:AddButton("Di Chuyển Đến Tộc Cyborg",function()
  topos(CFrame.new(28492.4140625, 14894.4267578125, -422.1100158691406))
  end)
  
  RaceV4:AddButton("Di Chuyển Đến Tộc Cá",function()
  topos(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
  end)
  
  RaceV4:AddButton("Di Chuyển Đến Tộc Quỷ",function()
  topos(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
  end)
  
  RaceV4:AddButton("Di Chuyển Đến Tộc Người",function()
  topos(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
  end)
  
  RaceV4:AddButton("Di Chuyển Đến Tộc Thỏ",function()
  topos(CFrame.new(29020.66015625, 14889.4267578125, -379.2682800292969))
  end)
  
  RaceV4:AddButton("Di Chuyển Đến Tộc Thiên thần",function()
  topos(CFrame.new(28967.408203125, 14918.0751953125, 234.31198120117188))
  end)

  RaceV4:AddSeperator("Tự Động Complete Trials")
  
  RaceV4:AddToggle("Tự Động Giết Người Chơi",false,function(Val)
  _G.AutoKillTial = Val
...
spawn(function()
    ...
    P:AddButton("Hủy Người Chơi",function()
        Playerslist = {}
        SelectedPly:Clear()
        for i,v in pairs(game:GetService("Players"):GetChildren()) do  
    ...
    P:AddToggle("Xem Người Chơi",false,function(value)
        SpectatePlys = value
...
spawn(function()
    ...
    spawn(function()
        while wait() do
            if _G.AutoSelectDungeon then
                pcall(function()
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Trái Lửa") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Flame-Flame") then
                        _G.SelectChip = "Trái Lửa"
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Trái băng") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Ice-Ice") then
                        _G.SelectChip = "Trái Băng"
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Trái Chấn Động") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Quake-Quake") then
                        _G.SelectChip = "Trái Chấn Động"
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Trái Ánh Sáng") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Light-Light") then
                        _G.SelectChip = "Trái Ánh Sáng"
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Trái Bóng Tối") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dark-Dark") then
                        _G.SelectChip = "Trái Bóng Tối"
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Trái Tơ") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("String-String") then
                        _G.SelectChip = "Trái Tơ"
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Trái Lôi") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Rumble-Rumble") then
                        _G.SelectChip = "Trái Lôi"
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Trái Dung Nham") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Magma-Magma") then
                        _G.SelectChip = "Trái Dung Nham"
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Trái Phật Tổ") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Human-Human: Buddha Fruit") then
                        _G.SelectChip = "Trái Phật"
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Trái Cát") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sand-Sand") then
                        _G.SelectChip = "Trái Cát"
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Trái Phoenix") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bird-Bird: Phoenix") then
                        _G.SelectChip = "Trái Phoenix"
    ...
    R:AddToggle("ESP Người Chơi",false,function(a)
        ESPPlayer = a
	UpdatePlayerChams()
    end)
    ...
    T:AddToggle("Di Chuyển Đến",false,function(value)
        ...
        if _G.TeleportIsland == true then
            repeat wait()
                ...
                elseif _G.SelectIsland == "Thị Trấn Cảng" then
